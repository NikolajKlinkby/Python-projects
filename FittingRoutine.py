...
class FittingRoutine:
    ...
    def Plot(self, ms=5, capsize = 3, elinewidth=None, lw=None, xlabel='x', ylabel='y', figsize=(6,6), init=False, legend=True, stats=True, do_return=False, legend_loc = 'upper right', save=None, yscale='linear', xscale='linear'):
